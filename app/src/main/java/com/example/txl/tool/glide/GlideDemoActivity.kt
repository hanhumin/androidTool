...
//        Glide.with(this).asBitmap().load(Uri.parse("file:///android_asset/test_video.mp4")).into(image_test_glide_mp4)
        Glide.with(this).asBitmap().load("file:///android_asset/test_video.mp4").apply(RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE)).into(image_test_glide_mp4)
